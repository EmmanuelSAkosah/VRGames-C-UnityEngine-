...
namespace VRStandardAssets.Menu
{
    ...
    {
       // public event Action<ShowRadial> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        ...
        {
            // When the user looks away from number, hide the radial and unfill it
            m_SelectionRadial.hideAndUnFill();
            m_GazeOver = false;
        }
